...
public class StoreFront {
	...
	public static boolean unitTest() {
		...
		//Test constructor
		Weapon weapon1 = new Weapon("Weapon", "This is a description for a weapon product", 1);
		...
		//Test constructor
		Armor armor1 = new Armor("Armor", "This is a description for an armor product", 12);
		...
		//Test constructor
		Health health1 = new Health("Health", "This is a description for a health product", 12);
